...
$checks = @(
    ...
    @{ Name = "Backend health"; Url = "http://localhost:8000/api/v1/actuator/health"; Method = "GET" },
    @{ Name = "Backend direct course API"; Url = "http://localhost:8000/api/v1/course-pack"; Method = "GET" },
