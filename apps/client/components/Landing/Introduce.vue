<template>
  ...
  >
    ...
    />
    <section class="flex w-full flex-col items-center justify-around gap-6 px-4 py-8 md:flex-row md:items-stretch md:px-0">
      <div
      ...
      >
        ...
        >
          ...
          <p class="py-1 leading-7">
            当自己可以独立拼出俄语单词和句子时，会非常有成就感，所以也会越学越想学。俄语学习平台会先降低入门门槛，再逐步增加真实句子的难度。
          </p>
        </div>
      </div>
    </section>
