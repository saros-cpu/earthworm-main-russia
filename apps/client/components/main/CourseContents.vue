            ...
            >
              <UTooltip text="播放发音">
                <UIcon
                  ...
                  @click="handlePlayEnglishSound($event, item.targetText || item.english)"
                ></UIcon>
              </UTooltip>
            </div>
          </div>
