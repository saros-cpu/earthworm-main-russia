<template>
  ...
  >
    <figure class="relative aspect-[4/3] overflow-hidden bg-slate-100 dark:bg-slate-800">
      <NuxtImg
        :src="coursePack.cover"
        :placeholder="[288, 216]"
        width="288"
        height="216"
        class="inset-0 h-full w-full object-cover transition duration-500 group-hover:scale-105"
      />
