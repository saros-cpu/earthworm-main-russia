<template>
  <div class="flex flex-col items-center gap-6">
    <div class="w-full max-w-xl">
      <div
        class="rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-800 p-6 text-center text-white shadow-lg"
      >
        <UIcon
    ...
    <div
      v-if="error"
      class="w-full max-w-xl rounded-md border border-rose-300 bg-rose-50 p-3 text-xs text-rose-700 dark:border-rose-900 dark:bg-rose-950/40 dark:text-rose-200"
    >
      {{ error }}
      <button
