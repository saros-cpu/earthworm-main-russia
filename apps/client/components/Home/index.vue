  ...
  <div class="grid w-full gap-5 py-5 lg:grid-cols-[220px_minmax(0,1fr)_280px]">
    <aside class="hidden lg:block">
      <div class="sticky top-20 space-y-3">
        ...
        <nav
          class="rounded-md border border-slate-200 bg-white p-2 text-sm shadow-sm dark:border-slate-800 dark:bg-slate-900"
        >
          <NuxtLink
          ...
          >
            <UIcon
              name="i-ph-book-open-text-duotone"
              class="h-5 w-5"
            />
            帮助文档
          </NuxtLink>
          ...
          >
            <UIcon
              name="i-ph-hands-praying-duotone"
              class="h-5 w-5"
            />
            建议反馈
          </NuxtLink>
        ...
        <div class="grid gap-3 md:grid-cols-3">
          ...
          >
            <div class="mb-4 flex items-center gap-3">
              <span
                class="flex h-10 w-10 items-center justify-center rounded-md bg-white text-emerald-700 shadow-sm dark:bg-slate-900 dark:text-emerald-300"
              >
                <UIcon
                  :name="task.icon"
                  class="h-5 w-5"
