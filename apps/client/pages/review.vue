<template>
  <div class="w-full py-6">
    ...
    >
      ...
      <div class="mt-4 flex gap-4">
        <div
          ...
          :key="s.label"
          class="flex-1 rounded-md bg-slate-50 p-3 text-center dark:bg-slate-800"
        >
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            v-if="!isCorrect"
            class="mb-3 text-slate-600 dark:text-slate-300"
          >
    ...
    >
      ...
      <div class="mb-1 text-lg font-bold">暂无待复习内容</div>
...
const qualityOptions = [
  {
    value: 1,
    label: "完全不记得",
    class: "bg-red-100 text-red-700 hover:bg-red-200 dark:bg-red-900 dark:text-red-200",
    activeClass: "bg-red-200 text-red-800 ring-2 ring-red-400",
  },
  {
    value: 2,
    label: "有点印象",
    ...
    activeClass: "bg-orange-200 text-orange-800 ring-2 ring-orange-400",
  },
  {
    value: 3,
    label: "勉强答对",
    ...
    activeClass: "bg-yellow-200 text-yellow-800 ring-2 ring-yellow-400",
  },
  {
    value: 4,
    label: "答对了，但犹豫",
    class: "bg-lime-100 text-lime-700 hover:bg-lime-200 dark:bg-lime-900 dark:text-lime-200",
    activeClass: "bg-lime-200 text-lime-800 ring-2 ring-lime-400",
  },
  {
    value: 5,
    label: "完全正确！",
    ...
    activeClass: "bg-emerald-200 text-emerald-800 ring-2 ring-emerald-400",
  },
];
  ...
  if (currentIndex.value < dueItems.value.length) {
    ...
    try {
      const course = await fetchCourse(
        currentReview.value.coursePackId,
        currentReview.value.courseId,
      );
