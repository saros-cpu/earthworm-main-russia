      ...
      <div class="overflow-x-auto">
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
            ...
            >
              <td class="px-5 py-3 font-mono text-slate-600 dark:text-slate-300">
                {{ user.username }}
              </td>
              <td class="px-5 py-3">
              ...
              <td class="px-5 py-3 text-center">
                <div class="flex items-center justify-center gap-1">
                  <button
                    class="rounded px-2 py-1 text-xs font-bold text-blue-600 hover:bg-blue-50 hover:text-blue-800 dark:text-blue-400 dark:hover:bg-blue-950/50"
                    @click="openEdit(user)"
                  >
                    编辑
                  </button>
    ...
    >
      ...
      >
        ...
        <div class="mt-6 flex justify-end gap-2">
          <button
            class="rounded-md border border-slate-300 px-4 py-2 text-sm font-bold text-slate-700 hover:bg-slate-50 dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-800"
            @click="editing = null"
          >
            取消
          </button>
