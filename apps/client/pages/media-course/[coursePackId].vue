  ...
  <div class="flex w-full flex-col py-6">
    ...
    <template v-else>
      ...
      >
        ...
        >
          <div
            class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-emerald-100 text-emerald-600 dark:bg-emerald-950 dark:text-emerald-300"
          >
            <UIcon
              v-if="mediaType(course) === 'video'"
              name="i-ph-video"
              class="h-6 w-6"
            />
            <UIcon
