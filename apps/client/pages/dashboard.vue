  ...
  <div class="mx-auto max-w-screen-xl space-y-6 p-6">
    ...
    >
      ...
      >
        ...
        <div class="mt-2 text-4xl font-black text-slate-950 dark:text-white">
          {{ stats.totals.packs }}
        </div>
      </article>
      <article
        ...
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
            ...
            >
              ...
              <td class="px-2 py-2 text-right font-mono text-slate-700 dark:text-slate-200">
                {{ p.courses }}
              </td>
              <td
                class="px-2 py-2 text-right font-mono font-bold text-emerald-700 dark:text-emerald-300"
              >
