    ...
    >
      ...
      >
        <div class="mb-2 flex items-start justify-between gap-2">
          <div>
            <button
              class="text-left text-lg font-black text-slate-950 hover:text-emerald-700 dark:text-white dark:hover:text-emerald-300"
...
import { fetchRemoveVocabulary, fetchVocabulary } from "~/api/learning";
