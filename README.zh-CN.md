<div align="center">
  <img alt="俄语学习平台" width="120" height="120" src="./.github/assets/russian-learning-logo.png">
  <h1>俄语学习平台 · Russian Learning</h1>
...
> Hard fork of [cuixueshe/earthworm](https://github.com/cuixueshe/earthworm). The entire backend, database, and course data have been **rewritten for Russian**. Branding fully migrated to "俄语学习平台 / Russian Learning".
...
| http://IP:3000 | LAN/public access (e.g. `http://your-server-ip:3000`) |
...
apps/client/public/
  logo.png                  Neutral brand image
  logo-circle.png           Neutral circular icon
```
