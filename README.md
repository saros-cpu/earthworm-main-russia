...
> 本仓库源自 [cuixueshe/earthworm](https://github.com/cuixueshe/earthworm)（英语连词成句训练）的深度改造分支。**整套后端 / 数据库 / 课程数据已全部重写为俄语版**，品牌已全面替换为「俄语学习平台」。
...
| http://IP:3000 | 局域网/公网访问（如 `http://your-server-ip:3000`） |
...
| 文件 | 用途 |
|---|---|
| `apps/client/public/logo.png` | 导航栏左上角中性品牌图 |
| `apps/client/public/logo-circle.png` | 其他位置使用的圆形中性图标 |
